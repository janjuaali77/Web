    ...
    <header className="sticky top-0 z-40 w-full bg-white shadow-sm border-b border-primary-100">
      ...
      <div className="bg-primary-900 text-primary-50 py-2 text-xs md:text-sm">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <p className="hidden md:block">Serving the Greater Area since 1985</p>
          <div className="flex space-x-6">
            <a href="tel:+1234567890" className="flex items-center hover:text-primary-300 transition-colors">
              <Phone size={14} className="mr-2" /> (555) 123-4567
            </a>
            <span className="flex items-center">
              <MapPin size={14} className="mr-2" /> 123 Craftsman Blvd, Design City
            </span>
          </div>
        </div>
      </div>
